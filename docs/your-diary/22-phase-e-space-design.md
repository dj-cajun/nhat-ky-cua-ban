...
> **상태**: E1–E3 반영 · E2 [23](./23-phase-e2-prototype-checklist.md) · E3 [24](./24-phase-e3-structure.md) · 다음 E4  
...
E2는 정적 프로토타입으로 **네 화면이 한 호흡으로 읽히는지** 검증했다. E3는 제품 경로에 구조를 반영했다 (실데이터·서버 close-3는 E5).
