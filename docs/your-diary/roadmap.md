...
**10.5단계 레거시 정리 완료** → 다음은 **11 통합 안정화·베타 준비**  
(로딩·빈 화면·오류·접근성·성능·운영)
...
| 조건 | 상태 |
|------|------|
| 날짜별 Spotify 곡 최대 1 · 검색/링크 | ✅ |
| 서버 메타데이터 재검증 · 직접 DML 차단 | ✅ |
| 다이어리 공개 범위·차단 상속 · 자동재생 없음 | ✅ |
| Spotify 앱/웹 이동 · 브랜드·원본 커버 유지 | ✅ |
| Edge secret만 · 검색 빈도 제한 · 취향 분석 없음 | ✅ |
| 018만 추가 · 017 이하 무수정 | ✅ |
