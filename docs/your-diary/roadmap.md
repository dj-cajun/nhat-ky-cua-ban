...
학교 레이어: [20](./20-school-trust-boundary-plan.md) — **B 완료 · B.1 하드닝** → C 온보딩 전 staging JWT·혼재 큐·ops role 차단
...
| **12·B.1** | staging JWT · 혼재 ops 큐 · ops role 하드코딩 제거 | ⏳ | [20](./20-school-trust-boundary-plan.md) · `020` |
