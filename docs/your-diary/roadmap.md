...
**E4 모션·오브제 반영.** 지금은 **Phase E5** — 공지/편지/달력/토마토·close-3 실데이터 연결 ([22](./22-phase-e-space-design.md) · [25](./25-phase-e4-motion.md)).
...
| **12·E** | 우주·다이어리 공간 재설계 | ⏳ E4 모션 · **E5** | [22](./22-phase-e-space-design.md) · [25](./25-phase-e4-motion.md) |
