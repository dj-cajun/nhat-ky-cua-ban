...
**7단계 신고·차단 기반 완료** → 다음은 **8 가명 게시판**  
(가명은 신고·차단 RPC를 공통 사용)
...
| 조건 | 상태 |
|------|------|
| block / unblock RPC · 한쪽 차단=양방향 개인 제한 | ✅ |
| 다이어리·사진 signed URL·방명록 차단 | ✅ |
| 가입 추천 차단 재검사 유지 | ✅ |
| Presence에서 차단 대상 배지 숨김 | ✅ |
| submit_report + 서버 스냅샷 | ✅ |
| hide_for_me / hidden_content | ✅ |
| 본인 신고 상태만 조회 | ✅ |
| 운영자 RPC + 감사 로그 | ✅ |
| 계정 restricted/suspended | ✅ |
| 015만 추가 · 014 이하 무수정 | ✅ |
