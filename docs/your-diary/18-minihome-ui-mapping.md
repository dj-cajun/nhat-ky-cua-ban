...
> **최종 갱신**: 2026-07-27  
> 옛 미니홈피 **인터페이스**는 살린다. **10자·사진첩 슬롯만** 책상 장면([27](./27-desk-scene-layered-sprites.md))으로 치환.
...
| 프로필 카드 | 기분 · 서클 뱃지 · Edit (10자 본문은 책상 메모로 이동 — [27](./27-desk-scene-layered-sprites.md)) |
| 사진첩 | **DeskScene 코르크보드** (미니 앨범 패널 치환) |
| 캘린더 | 주간 다이어리 10자 미리보기 (유지) |
| 10자 「Today I…」 | **DeskScene 메모지** |
